...
const NAV_GROUPS:{label:string;items:View[]}[]=[
  ...
  {label:"ESG 데이터·공시",items:["collection-request","metric-collection","review","indicators","evidence","reports"]},
