  ...
  return <div className="app-shell">
    ...
    <div className="workspace">
      ...
      <main className="content">
        {activeView === "dashboard" && <Dashboard records={records} periods={periods} targets={targets} plans={plans} organizationNames={organizationNames} canWrite={canWrite} canReview={canReview} onNavigate={navigate} onNew={() => openForm()} />}
...
function Dashboard({ records, periods, targets, plans, organizationNames, canWrite, canReview, onNavigate, onNew }: { records: ActivityRecord[]; periods: CollectionPeriod[]; targets: ReductionTarget[]; plans: ReductionPlan[]; organizationNames: string[]; canWrite: boolean; canReview: boolean; onNavigate: (view: View) => void; onNew: () => void }) {
