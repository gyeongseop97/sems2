...
export default function Home() {
  ...
  const [indicators, setIndicators] = useState<Indicator[]>(DEFAULT_MASTER_INDICATORS);
  ...
  const restoreBackup = (payload: Record<string, unknown>) => {
    ...
    if (Array.isArray(payload.evidence)) setEvidence(payload.evidence as EvidenceItem[]); if (Array.isArray(payload.indicators)) setIndicators(mergeMasterRows(payload.indicators as Indicator[],DEFAULT_MASTER_INDICATORS)); if (Array.isArray(payload.audit)) setAudit(payload.audit as AuditEvent[]);
